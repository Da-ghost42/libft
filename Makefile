...
ft_memchr.c ft_substr.c ft_strdup.c ft_atoi.c ft_memcmp.c ft_strtrim.c ft_strjoin.c ft_calloc.c ft_strnstr.c ft_split.c\
ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_itoa.c ft_putnbr_fd.c ft_strmapi.c ft_striteri.c
CC = gcc
